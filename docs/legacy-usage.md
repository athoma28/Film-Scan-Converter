...
This guide applies only to the maintenance-only Python/Tkinter app. See
[How to Use](how-to-use.md) for the native macOS workflow and
[Installation](installation.md#legacy-python) for setup.
