...
4. Replace `{path to your Film Scan Converter VENV  python executable}` with the path to your VENV python binary e.g. `/home/user/dev/Film-Scan-Converter/.venv/bin/python`
...
6. Launch ART, you should have additional options for selecting folders and files for conversion
